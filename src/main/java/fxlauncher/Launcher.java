...
public class Launcher extends Application {
	 ...
	 */
	public FXManifest checkForUpdate() throws Exception {
		// We might be called even when FXLauncher wasn't used to start the application
		if (superLauncher.manifest == null)
			return null;
		FXManifest old = superLauncher.manifest;
		superLauncher.syncManifest();
		return old.equals(superLauncher.manifest) ? null : superLauncher.manifest;
	}
